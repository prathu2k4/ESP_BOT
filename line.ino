...
// Function to apply the PID control and adjust motor speeds accordingly
void applyPID() {
...
// Handle the status endpoint for checking the WiFi and PID settings
void handleStatus() {
    String json = "{";
...
// Handle the update endpoint to update the PID constants
void handleUpdate() {
...
void loop() {
    ...
    applyPID();             // Apply the PID control to adjust motor speeds
}